...
import { HomeIcon, BanknotesIcon, CalendarDaysIcon, UsersIcon, QuestionMarkCircleIcon } from "@heroicons/react/24/outline";
...
const navigation = [
  ...
  { name: "Giải đáp thắc mắc", href: "/questionsAndAnswers/questionsAndAnswers", icon: QuestionMarkCircleIcon, current: false },
];
